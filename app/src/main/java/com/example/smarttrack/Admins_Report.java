    ...
    private void setupClickListeners() {
        ...
        dailyAttendanceButton.setOnClickListener(v -> {
            if (uid == null) {
                ...
                Toast.makeText(Admins_Report.this, "Error: Unable to open attendance. No user ID.", Toast.LENGTH_SHORT).show();
                return;
            }

            Log.d("Students_Report", "✅ Opening DailyAttendanceActivity with UID: " + uid);

            Intent intent = new Intent(Admins_Report.this, DailyAttendanceActivity.class);
        ...
        monthlyAttendanceButton.setOnClickListener(v -> {
            Intent intent = new Intent(Admins_Report.this, MonthlyAttendanceActivity.class);
