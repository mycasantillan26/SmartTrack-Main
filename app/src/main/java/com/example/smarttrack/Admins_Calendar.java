...
public class Admins_Calendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roomIcon.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Admins_Calendar.this, Admins_Room.class);
        ...
        homeIcon.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Admins_Calendar.this, Admins_Home.class);
            intent.putExtra("uid", uid);
            startActivity(intent);
            overridePendingTransition(0, 0);
        });
        ...
        reportIcon.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Admins_Calendar.this, Admins_Calendar.class);
            intent.putExtra("uid", uid);
            startActivity(intent);
            overridePendingTransition(0, 0);
        });
