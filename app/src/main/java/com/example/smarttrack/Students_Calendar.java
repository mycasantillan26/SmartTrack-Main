...
public class Students_Calendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roomIcon.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Students_Calendar.this, Students_Room.class);
        ...
        homeIcon.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Students_Calendar.this, Students_Home.class);
            intent.putExtra("uid", uid);
            startActivity(intent);
            overridePendingTransition(0, 0);
        });
        ...
        reportIcon.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Students_Calendar.this, Students_Report.class);
            intent.putExtra("uid", uid);
            startActivity(intent);
            overridePendingTransition(0, 0);
        });
